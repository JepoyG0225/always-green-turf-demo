// Jobber Job → QBO customer + project. Reachable directly (for testing) or via
// the /api/jobber-payment dispatcher when Jobber posts a JOB_CREATE webhook.
//   POST { itemId | jobId }  or a Jobber webhook body   (?dryRun=1 to test)
const { run } = require("./_jobber-job");
